    ...
    <div className="min-h-screen bg-ink-950 text-white pt-24 pb-12 flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-block p-4 bg-ink-900/50 rounded-full border border-white/5 mb-4 group hover:border-ink-accent/50 transition-colors">
        ...
        <div className="bg-ink-900/40 backdrop-blur-xl border border-white/10 p-8 rounded-2xl shadow-2xl">
          ...
          <div className="mt-8 pt-6 border-t border-white/5 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <Link to="/signup" className="text-ink-accent font-bold hover:text-white transition-colors ml-1">
                Sign Up
              </Link>
            </p>
          </div>
