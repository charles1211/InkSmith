...
const SLUG = 'piercing';
const PATH = '/aftercare/piercing';
const guide = getAftercareGuide(SLUG);

export const metadata: Metadata = buildMetadata({
  title: guide?.metaTitle ?? 'Piercing Aftercare',
...
const CRUMBS = [
  ...
  { name: 'Piercing Aftercare', href: PATH },
];

export default function PiercingAftercarePage() {
  if (!guide) notFound();
  ...
  return (
    <div className="min-h-screen bg-ink-950 text-white selection:bg-ink-accent selection:text-black overflow-x-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 pb-32 relative z-10">
        ...
        <FaqSection
          heading="Piercing aftercare questions"
          faqs={faqs}
          className="mt-16"
        />
        <EmergencyNotice />
