...
const Home: React.FC = () => {
  ...
  const features = useScrollAnimation<HTMLElement>({ threshold: 0.2 });
    ...
    <div className="flex flex-col min-h-screen bg-ink-950 text-white selection:bg-ink-accent selection:text-black">
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden z-10">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto space-y-6 flex flex-col items-center">
          ...
          {/* Stagger 1: Badge + line */}
          <div className="anim-hero-badge space-y-2">
             ...
             <div className="h-px w-20 bg-ink-accent/50 mx-auto anim-hero-line"></div>
          </div>

          {/* Stagger 2: Icon with bounce */}
          <div className="anim-hero-badge" style={{ animationDelay: '0.4s' }}>
          ...
          {/* Stagger 3: Main title with skew reveal */}
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl font-black text-white tracking-tighter uppercase leading-none anim-hero-title drop-shadow-2xl" style={{ animationDelay: '0.3s' }}>
            Tattoo <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-400">and Body Piercing</span>
          </h1>

          {/* Stagger 4: Buttons rise up */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8 anim-hero-buttons">
            <Link
              href="/book"
      ...
      {/* ============================================= */}
      {/* 2. INTRO - Slide in from sides                */}
      {/* ============================================= */}
      <section ref={intro.ref} className="py-24 lg:py-32 relative z-10 bg-ink-950/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className={`lg:col-span-5 relative ${intro.isVisible ? 'anim-slide-right' : 'scroll-hidden'}`} style={{ animationDelay: '0.2s' }}>
      ...
      {/* ============================================= */}
      {/* 3. FEATURES GRID - Staggered flip-up cards    */}
      {/* ============================================= */}
      <section ref={features.ref} className="relative border-y border-white/5 bg-fixed bg-center bg-cover py-12" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1590247813693-5541d1c609fd?auto=format&fit=crop&q=80")', backgroundAttachment: 'fixed' }}>
        <div className="absolute inset-0 bg-ink-950/90"></div>
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/5 max-w-7xl mx-auto">
          {[
            ...
            <div
              key={idx}
              className={`p-12 group hover:bg-white/5 transition-colors duration-500 ${
                features.isVisible
                  ? `anim-flip-up-${idx + 1}`
                  : 'scroll-hidden'
              }`}
      ...
      {/* ============================================= */}
      {/* 4. STUDIO SHOWCASE - Curtain open              */}
      {/* ============================================= */}
      <section ref={studio.ref} className="py-32 overflow-hidden bg-ink-950/90 relative z-10">
        <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 flex flex-col md:flex-row items-end justify-between gap-8 ${studio.isVisible ? 'anim-curtain-left' : 'scroll-hidden'}`}>
          <div>
      ...
      {/* ============================================= */}
      {/* 5. TATTOO GALLERY - Mosaic cascade reveal     */}
      {/* ============================================= */}
      <section ref={gallery.ref} className="py-24 bg-ink-950/95 border-t border-white/5 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center max-w-3xl mx-auto mb-20 ${gallery.isVisible ? 'anim-gallery-title' : 'scroll-hidden'}`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-1 md:gap-4">
            {recentWorks.map((work, idx) => (
              <div
                key={work.id}
                className={`aspect-square relative group overflow-hidden bg-ink-950 cursor-pointer ${
                  gallery.isVisible ? 'anim-mosaic' : 'scroll-hidden'
                }`}
                style={gallery.isVisible ? { animationDelay: `${idx * 0.08}s` } : undefined}
              >
                <img
                  src={work.src}
                  alt={work.title}
          ...
          <div className={`text-center mt-16 ${gallery.isVisible ? 'anim-mosaic' : 'scroll-hidden'}`} style={gallery.isVisible ? { animationDelay: '0.7s' } : undefined}>
            <Link
              href="/portfolio"
      ...
      {/* ============================================= */}
      {/* 6. PIERCING - Elastic entrance with depth     */}
      {/* ============================================= */}
      <section ref={piercing.ref} className="py-32 bg-gradient-to-b from-ink-900 to-ink-950 relative z-10 border-t border-white/5 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-20">
             ...
             {/* Featured Image - elastic from right */}
             <div className={`lg:w-1/2 relative group ${piercing.isVisible ? 'anim-elastic-right' : 'scroll-hidden'}`} style={piercing.isVisible ? { animationDelay: '0.15s' } : undefined}>
                ...
                <div className="relative h-[600px] w-full rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                  ...
                  <div className="absolute bottom-8 left-8 right-8">
                    <div className="text-white text-xl font-serif italic mb-2">&ldquo;Safety is our signature.&rdquo;</div>
          ...
          {/* Piercing Grid - Cascading up */}
          <div className="space-y-8">
            <div className={`text-center max-w-2xl mx-auto mb-12 ${piercing.isVisible ? 'anim-cascade' : 'scroll-hidden'}`} style={piercing.isVisible ? { animationDelay: '0.3s' } : undefined}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
              {piercingTypes.map((piercingItem, idx) => (
                <div
                  key={idx}
                  className={`group relative aspect-[4/5] overflow-hidden rounded-xl bg-ink-800 border border-white/5 shadow-lg cursor-default ${
                    piercing.isVisible ? 'anim-cascade' : 'scroll-hidden'
                  }`}
                  style={piercing.isVisible ? { animationDelay: `${0.4 + idx * 0.05}s` } : undefined}
                >
                  <img
      ...
      {/* ============================================= */}
      {/* 7. PRE-FOOTER CTA - Dramatic zoom pulse       */}
      {/* ============================================= */}
      <section ref={cta.ref} className="py-24 relative overflow-hidden z-10">
        ...
        <div className={`max-w-4xl mx-auto px-4 text-center relative z-10 ${cta.isVisible ? 'anim-zoom-pulse' : 'scroll-hidden'}`}>
          <h2 className="text-4xl md:text-6xl font-serif font-bold text-white mb-8 uppercase anim-underline-sweep">
